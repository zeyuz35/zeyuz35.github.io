...
Use tensorflow to fit these. A GPU is not strictly necessary, as the data and models are not actually complex enough. The bottleneck seems to be transferring the data from the CPU to the GPU, not the actual fitting. Still, it is marginally 
